...
function Header(){
  return (
    <div className="container">
        <div className='row'>
            <div className='col-3 bg-light d-flex justify-content-center align-items-center gap-5'>
                <div className='py-4'>
            ...
            <div className='col-6 bg-light d-flex justify-content-center align-items-center'>
